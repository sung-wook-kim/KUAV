...
while True:
    ...
    if key == '1':
        ...
        li_in = [0x46, 0x43, 0x00, in_roll_p_4, in_roll_p_3, in_roll_p_2, in_roll_p_1, in_roll_i_4, in_roll_i_3,
                 in_roll_i_2,
                 in_roll_i_1, in_roll_d_4, in_roll_d_3, in_roll_d_2, in_roll_d_1, 0x00, 0x00, 0x00, 0x00]
        li_out = [0x46, 0x43, 0x01, out_roll_p_4, out_roll_p_3, out_roll_p_2, out_roll_p_1, out_roll_i_4, out_roll_i_3,
                  out_roll_i_2,
        ...
        li_in = [0x46, 0x43, 0x02, in_pitch_p_4, in_pitch_p_3, in_pitch_p_2, in_pitch_p_1, in_pitch_i_4, in_pitch_i_3,
                 in_pitch_i_2,
                 in_pitch_i_1, in_pitch_d_4, in_pitch_d_3, in_pitch_d_2, in_pitch_d_1, 0x00, 0x00, 0x00, 0x00]
        li_out = [0x46, 0x43, 0x03, out_pitch_p_4, out_pitch_p_3, out_pitch_p_2, out_pitch_p_1, out_pitch_i_4,
                  out_pitch_i_3, out_pitch_i_2,
        ...
        li_out = [0x46, 0x43, 0x05, out_yaw_p_4, out_yaw_p_3, out_yaw_p_2, out_yaw_p_1, out_yaw_i_4, out_yaw_i_3,
                  out_yaw_i_2,
        ...
        alt_li_in = [0x46, 0x43, 0x06, in_alt_p_4, in_alt_p_3, in_alt_p_2, in_alt_p_1, in_alt_i_4, in_alt_i_3,
                     in_alt_i_2,
                     in_alt_i_1, in_alt_d_4, in_alt_d_3, in_alt_d_2, in_alt_d_1, 0x00, 0x00, 0x00, 0x00]
        alt_li_out = [0x46, 0x43, 0x07, out_alt_p_4, out_alt_p_3, out_alt_p_2, out_alt_p_1, out_alt_i_4, out_alt_i_3,
                      out_alt_i_2,
        ...
        li_out = [0x46, 0x43, 0x09, out_lat_p_4, out_lat_p_3, out_lat_p_2, out_lat_p_1, out_lat_i_4, out_lat_i_3,
                  out_lat_i_2,
        ...
        li_out = [0x46, 0x43, 0x0b, out_lon_p_4, out_lon_p_3, out_lon_p_2, out_lon_p_1, out_lon_i_4, out_lon_i_3,
                  out_lon_i_2,
